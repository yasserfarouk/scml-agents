...
import sys
from scml.scml2020.components.production import ProductionStrategy, SupplyDrivenProductionStrategy, DemandDrivenProductionStrategy
...
class MyAgent3(MyNegotiationManager, PredictionBasedTradingStrategy, SupplyDrivenProductionStrategy,
               SCML2020Agent):
    """My agent"""
    pass

class MyAgent4(MyNegotiationManager, PredictionBasedTradingStrategy, DemandDrivenProductionStrategy,
               SCML2020Agent):
    """My agent"""
    pass

class MyAgent5(_NegotiationCallbacks,
...
class MyAgent6(_NegotiationCallbacks,
        StepBuyBestSellNegManager,
        PredictionBasedTradingStrategy,
...
if __name__ == "__main__":
    ...
    world = SCML2020World(
        **SCML2020World.generate([DecentralizingAgent, MyAgent5, MyAgent6], n_steps=10, n_processes=3, n_agents_per_process=2),
