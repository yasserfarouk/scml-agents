...
df = pd.read_csv("/Users/jtsatsaros/SCML/newlogs_1/50_steps_3_levels/trial0/signed_contracts.csv")
...
game_logs = logs.rename(columns={'delivery_time': 'time', 'product_name': 'product', 'unit_price': 'price'})
...
for file in os.listdir(directory):
    ...
    if (filename != 'trial0' and filename != '.DS_Store'):
        totalpath = "/Users/jtsatsaros/SCML/newlogs_1/50_steps_3_levels/" + filename + "/signed_contracts.csv"
        ...
        log2 = log1.rename(columns={'delivery_time': 'time', 'product_name': 'product', 'unit_price': 'price'})
...
for file in os.listdir(directory):
    ...
    if (filename != '.DS_Store'):
        totalpath = "/Users/jtsatsaros/SCML/newlogs_2/50_steps_3_levels/" + filename + "/signed_contracts.csv"
        df = pd.read_csv(totalpath)
        raw_df = df[df.executed_at != -1]
        cols = set(raw_df.columns)
        cols_to_keep = set()
...
for file in os.listdir(directory):
    filename = os.fsdecode(file)
    if (filename != '.DS_Store'):
        totalpath = "/Users/jtsatsaros/SCML/newlogs_3/50_steps_3_levels/" + filename + "/signed_contracts.csv"
        df = pd.read_csv(totalpath)
        raw_df = df[df.executed_at != -1]
        cols = set(raw_df.columns)
        cols_to_keep = set()
...
for file in os.listdir(directory):
    filename = os.fsdecode(file)
    if (filename != '.DS_Store'):
        totalpath = "/Users/jtsatsaros/SCML/newlogs_4/50_steps_3_levels/" + filename + "/signed_contracts.csv"
        df = pd.read_csv(totalpath)
        raw_df = df[df.executed_at != -1]
        cols = set(raw_df.columns)
        cols_to_keep = set()
...
for file in os.listdir(directory):
    filename = os.fsdecode(file)
    if (filename != '.DS_Store'):
        totalpath = "/Users/jtsatsaros/SCML/newlogs_5/50_steps_3_levels/" + filename + "/signed_contracts.csv"
        df = pd.read_csv(totalpath)
        raw_df = df[df.executed_at != -1]
        cols = set(raw_df.columns)
        cols_to_keep = set()
