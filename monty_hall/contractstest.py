...
def solve_signer (buy_contracts:list, sel_contracts:list, prints: bool = False):
    ...
    t0 = time.time()
    # Decision variables
    buy_sign_vars = pulp.LpVariable.dicts('buy_sign', (i for i, _ in enumerate(buy_contracts)),
                                          lowBound=0, upBound=1, cat='Integer')
    sel_sign_vars = pulp.LpVariable.dicts('sel_sign', (i for i, _ in enumerate(sel_contracts)),
                                          lowBound=0, upBound=1, cat='Integer')
    ...
    print(f'it took {time_to_generate_ILP + solve_time : .4f} sec in total, and has opt profit of {pulp.value(model.objective):.4f}')

    sign_plan_buy  = {i: buy_sign_vars[b[3]].varValue for i, b in enumerate(buy_contracts_copy)}
    sign_plan_sel  = {i: sel_sign_vars[s[3]].varValue for i, s in enumerate(sel_contracts_copy)}
...
buy_contracts = [(12, 2, 10), (14, 2, 10), (15, 2, 10), (4, 2, 10), (15, 4, 10), (11, 4, 10), (4, 2, 10), (13, 2, 10), (1, 1, 10), (9, 4, 10), (18, 3, 10), (0, 3, 10), (12, 2, 10), (13, 1, 10), (6, 2, 10), (11, 1, 10), (7, 3, 10), (11, 2, 10), (9, 3, 10), (14, 1, 10), (21, 2, 10), (10, 4, 10), (1, 4, 10), (9, 1, 10), (17, 4, 10), (6, 1, 10), (2, 2, 10), (15, 4, 10), (19, 5, 10), (14, 4, 10), (18, 2, 10), (9, 3, 10), (0, 2, 10), (17, 1, 10), (14, 2, 10), (7, 2, 10), (3, 3, 10), (1, 5, 10), (15, 2, 10), (1, 3, 10), (13, 4, 10), (16, 3, 10), (10, 1, 10), (11, 2, 10), (14, 4, 10), (12, 2, 10), (19, 4, 10), (3, 1, 10), (2, 1, 10), (5, 3, 10), (13, 1, 10), (20, 3, 10)]

sel_contracts =[(6, 3, 10), (20, 1, 10), (21, 3, 10), (16, 1, 10), (10, 2, 10), (10, 2, 10), (16, 2, 10), (4, 1, 10), (19, 2, 10), (11, 2, 10), (8, 1, 10), (10, 2, 10), (1, 2, 10), (7, 3, 10), (17, 4, 10), (3, 3, 10), (20, 3, 10), (22, 2, 10), (1, 1, 10), (5, 3, 10), (22, 4, 10), (16, 1, 10), (17, 4, 10), (7, 2, 10), (21, 2, 10), (15, 1, 10), (7, 2, 10), (9, 1, 10), (12, 3, 10), (16, 3, 10), (4, 3, 10), (15, 2, 10), (13, 3, 10), (6, 1, 10), (19, 1, 10), (22, 1, 10), (21, 2, 10), (18, 1, 10), (22, 2, 10), (2, 2, 10), (0, 2, 10), (10, 2, 10), (6, 3, 10), (2, 5, 10), (3, 3, 10), (7, 2, 10), (18, 3, 10), (3, 4, 10), (22, 1, 10), (12, 3, 10), (8, 5, 10), (22, 3, 10), (1, 1, 10), (14, 1, 10)]
