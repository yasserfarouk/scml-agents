...
from scml.scml2020 import SCML2020Agent, PredictionBasedTradingStrategy, DecentralizingAgent, IndDecentralizingAgent, NO_COMMAND
...
class DrorOmer(DrorStepNegotiationManager,
                    PredictionBasedTradingStrategy,
                    #SupplyDrivenProductionStrategy,
                    OmerProductionStrategyAgent,
                    SCML2020Agent,):
