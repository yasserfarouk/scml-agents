...
from scml.scml2020 import SCML2020Agent, PredictionBasedTradingStrategy, DecentralizingAgent, IndDecentralizingAgent
...
class DrorStepNegotiationManager(DrorMeanERPStrategy, DrorNegotiationManager):
    ...
    def add_controller(
        ...
        controller = DanasController(
            acc_unit_prices=self.seller_acc_unit_prices if is_seller else self.buyer_acc_unit_prices,
            is_seller=is_seller,
            target_quantity=target,
            negotiator_type=self.negotiator_type,
            negotiator_params=self.negotiator_params,
...
class DrorDana2StepAgent(DrorStepNegotiationManager,
