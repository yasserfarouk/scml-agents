...
def play_n_game(n, dror_agent):
    ...
    for n_simulations in range(n):
        world = SCML2020World(
            **SCML2020World.generate([dror_agent, DecentralizingAgent, IndDecentralizingAgent], n_steps=10),
...
def play_n_games(n, compare0, compare1, compare2, compare3):
    ...
    for n_simulations in range(n):
        world = SCML2020World(
            **SCML2020World.generate([compare0, DecentralizingAgent, compare1, compare2], n_steps=30),
            construct_graphs=True,
        )
...
#learn_param()
scores = play_n_games(30, DrorStepAgent, DrorDanaStepAgent, DrorOmer, DrorDana2StepAgent)
print(scores)
# scores = {}
# wins = {}
