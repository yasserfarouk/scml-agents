...
class My_ProductionStrategy(ProductionStrategy):
    def step(self):
        ...
        production_amount = max(schedule_amount,min(self.awi.state.inventory[self.awi.my_input_product],commands_threshold))
...
class Saving_Agent(_NegotiationCallbacks,
    StepNegotiationManager,
