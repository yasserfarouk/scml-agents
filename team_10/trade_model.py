...
class Model(nn.Module):
    def __init__(self, input_dim=TRADE_INPUT_DIM, hidden_dim=TRADE_HIDDEN_SIZE, output_dim=TRADE_OUTPUT_DIM):
    ...
    def fit(self, train_data, test_data, save_model=True, epochs=TRADE_EPOCHS, path=TRADE_INPUT_PATH):
        self.train()
