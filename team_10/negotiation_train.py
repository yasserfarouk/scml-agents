...
if NEG_TRAIN_SELLER:
    ...
    train_seller, valid_seller = seller_model.fit(train_seller_data, test_seller_data, save_model=NEG_SAVE_MODEL, path=NEG_SELL_PATH)
    seller_model.plot(train_seller, valid_seller)


if NEG_TRAIN_BUYER:
    print('buyer training...')
    train_buyer, valid_buyer = buyer_model.fit(train_buyer_data, test_buyer_data, save_model=NEG_SAVE_MODEL, path=NEG_BUY_PATH)
