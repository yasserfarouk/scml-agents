...
train_output_data = all_output_data[: -int(len(all_output_data) * TRADE_VALIDATION_SPLIT)]
test_output_data = all_output_data[-int(len(all_output_data) * TRADE_VALIDATION_SPLIT):]
...
train_input = False
if train_input:
    train_input, valid_input = input_model.fit(train_input_data, test_input_data, save_model=TRADE_SAVE_MODEL, path=TRADE_INPUT_PATH)
    input_model.plot(train_input, valid_input)

train_output = True
if train_output:
    train_output, valid_output = output_model.fit(train_output_data, test_output_data, save_model=TRADE_SAVE_MODEL, path=TRADE_OUTPUT_PATH)
