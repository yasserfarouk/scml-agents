...
class UtilityModel(nn.Module, autograd.Function):
    def __init__(self, is_seller, input_dim=UTILITY_INPUT_DIM, hidden_dim=UTILITY_HIDDEN_SIZE, output_dim=UTILITY_OUTPUT_DIM):
    ...
    def fit(self, train_data, test_data, save_model=True, epochs=UTILITY_EPOCHS, path=None):
        if not path:
        ...
        for epoch in range(epochs): # again, normally you would NOT do 300 epochs, it is toy data
            ...
            for input, tag in train_data:
                ...
                if (counter % 10 == 0):
                    ...
                    print('[%d / %d] train loss: %.3f\tvalidation loss: %.3f'
