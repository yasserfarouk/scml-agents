...
class BossNegoStats():
	...
	def set_negotiation_bid_history(self, step, agentID, mechanism_id, negotiation_history):
		...
		if agentID in self.__parent.my_consumers:
			self.negotiation_bid_history['buyer'][step][agentID][mechanism_id] = copy.deepcopy(negotiation_history)
		else:
			self.negotiation_bid_history['seller'][step][agentID][mechanism_id] = copy.deepcopy(negotiation_history)


	def set_negotiation_bid_sign(self, step, agentID, mechanism_id, agent_sign, opponent_sign):
		if agentID in self.__parent.my_consumers:
			self.negotiation_bid_history['buyer'][step][agentID][mechanism_id]['Acceptance']['agent_sign'] = agent_sign
		else:
			self.negotiation_bid_history['seller'][step][agentID][mechanism_id]['Acceptance']['opponent_sign'] = opponent_sign	

		# Save it as json.
		self.save_dict(dict_to_save=self.negotiation_bid_history, file_name='negotiation_bid_history')
	...
	def set_opponent_respond_history(self, agentID, step, action_list):
		...
		'''	
		if agentID in self.__parent.my_consumers:
			self.opponent_respond_history['buyer'][step][agentID] = copy.deepcopy(action_list)
		else:
			self.opponent_respond_history['seller'][step][agentID] = copy.deepcopy(action_list)

		# Save it as json.
		self.save_dict(dict_to_save=self.opponent_respond_history, file_name='opponent_respond_history')
	...
	def set_agent_respond_history(self, agentID, step, action_list):
		...
		'''	
		if agentID in self.__parent.my_consumers:
			self.agent_respond_history['buyer'][step][agentID] = copy.deepcopy(action_list)
		else:
			self.agent_respond_history['seller'][step][agentID] = copy.deepcopy(action_list)
		# Save it as json.
		self.save_dict(dict_to_save=self.agent_respond_history, file_name='agent_respond_history')
