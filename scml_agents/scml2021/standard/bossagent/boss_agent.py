...
class CharliesAgent(BossBusinessPlanner, BossTradingStrategy, BossProductionStrategy, SCML2020Agent):
	"""
	...
	def init(self):
		...
		if self.awi_caller.is_first_level() or self.awi_caller.is_last_level():
			...
			self.NEGO_WINDOW = math.ceil(self.max_number_of_steps * 0.4) # Window size of the negotiation.
