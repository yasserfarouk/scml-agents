...
class AgentT064(AdaptiveAgent, ABC):
    ...
    def _good_price_range(self, ami: SAOAMI):
        ...
        price_range = {"min": mn + AgentT064.better_agent._th(ami.n_steps - 2, ami.n_steps) * (mx - mn),
                       "max": mx - AgentT064.better_agent._th(ami.n_steps - 2, ami.n_steps) * (mx - mn)}
...
class AgentT063(AdaptiveAgent, ABC):
    ...
    def _good_price_range(self, ami: SAOAMI):
        ...
        price_range = {"min": mn + AgentT063.better_agent._th(ami.n_steps - 2, ami.n_steps) * (mx - mn),
                       "max": mx - AgentT063.better_agent._th(ami.n_steps - 2, ami.n_steps) * (mx - mn)}
...
class AgentT062(AdaptiveAgent, ABC):
    ...
    def _good_price_range(self, ami: SAOAMI):
        ...
        price_range = {"min": mn + AgentT062.better_agent._th(ami.n_steps - 2, ami.n_steps) * (mx - mn),
                       "max": mx - AgentT062.better_agent._th(ami.n_steps - 2, ami.n_steps) * (mx - mn)}
...
class AgentT056(AdaptiveAgent, ABC):
    ...
    def _good_price_range(self, ami: SAOAMI):
        ...
        price_range = {"min": mn + AgentT056.better_agent._th(ami.n_steps - 2, ami.n_steps) * (mx - mn),
                       "max": mx - AgentT056.better_agent._th(ami.n_steps - 2, ami.n_steps) * (mx - mn)}
