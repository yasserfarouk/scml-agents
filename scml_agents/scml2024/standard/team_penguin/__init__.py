from .penguinagent import *

MAIN_AGENT = PenguinAgent
__all__ = penguinagent.__all__
...
ID = 20219
NAME = 'PenguinAgent'
CLASS_NAME = 'PenguinAgent'
VERSION = '3.10.9'
TEAM = 'Team Penguin'
AUTHOR = 'GouKazusa'
MEMBERS = [{'name': 'GouKazusa', 'institution': 'Nagoya Institute of Technology', 'country': 'Japan'}]
COUNTRY = 'Japan'
