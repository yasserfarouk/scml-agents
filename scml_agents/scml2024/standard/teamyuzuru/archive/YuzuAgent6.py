...
- first_proposalにおける数量の分配を均等になるように変更
...
class YuzuAgent6(OneShotSyncAgent):
    ...
    def counter_all(self, offers, states):
        ...
        for needs, all_partners, issues in [
            ...
            for i, partner_ids in enumerate(plist):
                ...
                # ec -> estimated_cost
                log_message(
                    f"estimated_cost: {estimated_cost:.5f} offers",
...
if __name__ == "__main__":
    ...
    for i in range(10):
        run([YuzuAgent6], sys.argv[1] if len(sys.argv) > 1 else "oneshot")
