...
from scml.oneshot.agents import GreedyOneShotAgent, GreedySyncAgent
...
def run(
    ...
    **Not needed for submission.** You can use this function to test your agent.
    ...
    if competition == "oneshot":
        competitors = list(competitors) + [SyncRandomStdAgent, GreedySyncAgent]
    else:
        competitors = list(competitors) + [GreedySyncAgent, SyncRandomStdAgent]
