...
class LitaAgentCIR(StdSyncAgent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if os.path.exists("env.test"):
            print(
                f"🤖 LitaAgentCIR {self.id} initialized with: \n"
                # ... (其他参数日志) ...
    ...
    def step(self) -> None:
        ...
        if targeted_today > 0:
            ...
            if (
                ...
                and abs(self.over_procurement_factor - original_over_proc_factor) > 1e-5
            ):
            ...
            if estimated_sellable_quantity > 0 and consumer_negotiators:
                ...
                for nid in sorted_consumer_nids:
                    ...
                    if (
                        ...
                        if (
                            os.path.exists("env.test")
                            and propose_q_for_this_consumer > 0
                        ):
    ...
    def _calculate_combination_profit_and_normalize(
        ...
        for negotiator_id, outcome in offer_combination.items():
            ...
            if nmi is None and os.path.exists(
                "env.test"
            ):  # Log if NMI was missing and fallback was used
